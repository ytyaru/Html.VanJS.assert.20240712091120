...
//        .catch(err=>this.__exceptMsg(isFalseSuccess, err))
    ...
    */
    ...
    __nCheck(bool) {
        ...
        //if (this._isFalseSuccess ? bool : !bool) { console.log(`__nCheck(bool):${this.__failMsg()}`, this._count);this._count.fail++; return this._consoleFail(this.__failMsg(), this._caller); throw new AssertionError(this.__failMsg()); }
        this._count.success++
        return true
    }
    __failMsg() {
