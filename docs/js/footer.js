...
class Footer {
    constructor(author, prePath) {
        ...
        this._created = '2024-07-11T21:35:13+0900'
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/assert/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
